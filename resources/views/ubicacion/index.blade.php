...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Ubicaciones</h1>
            ...
            <table id="datatablesSimple" class="table table-striped fs-6">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>{{$item->seccion ?? '-'}}</td>
                        <td>
                            @if($item->capacidad_maxima)
                                <span class="badge bg-secondary">{{$item->capacidad_maxima}}</span>
                            @else
                                -
                            @endif
                        </td>
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        ...
                                        <li><a class="dropdown-item" href="{{route('ubicaciones.edit',['ubicacione'=>$item])}}">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ¿Seguro que quieres desactivar la ubicación <strong>{{$item->nombre}}</strong>?
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                    <form action="{{ route('ubicaciones.destroy',['ubicacione'=>$item->id]) }}" method="post">
                                        @method('DELETE')
                                        @csrf
