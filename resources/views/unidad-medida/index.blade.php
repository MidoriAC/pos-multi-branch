...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Unidades de Medida</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
        <li class="breadcrumb-item active">Unidades de Medida</li>
    </ol>

    @can('crear-unidad-medida')
    <div class="mb-4">
        <a href="{{route('unidades-medida.create')}}">
            <button type="button" class="btn btn-primary">
                <i class="fas fa-plus"></i> Añadir Nueva Unidad de Medida
            </button>
        </a>
    </div>
    @endcan
            ...
            <table id="datatablesSimple" class="table table-striped fs-6">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="badge bg-secondary">{{$item->abreviatura}}</span>
                        </td>
                        <td>
                            @php
                            ...
                            <div class="d-flex justify-content-around">
                                <div>
                                    ...
                                    <ul class="dropdown-menu text-bg-light" style="font-size: small;">
                                        @can('editar-unidad-medida')
                                        <li><a class="dropdown-item" href="{{route('unidades-medida.edit',['unidades_medida'=>$item])}}">
                                ...
                                <div>
                                    @can('eliminar-unidad-medida')
                                    @if($item->estado == 1)
                                    <button title="Desactivar" data-bs-toggle="modal" data-bs-target="#confirmModal-{{$item->id}}" class="btn btn-datatable btn-icon btn-transparent-dark">
                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ¿Seguro que quieres desactivar la unidad de medida <strong>{{$item->nombre}}</strong>?
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                                    <form action="{{ route('unidades-medida.destroy',['unidades_medida'=>$item->id]) }}" method="post">
                                        @method('DELETE')
                                        @csrf
