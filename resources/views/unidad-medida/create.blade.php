...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">Crear Unidad de Medida</h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
        <li class="breadcrumb-item"><a href="{{ route('unidades-medida.index')}}">Unidades de Medida</a></li>
        <li class="breadcrumb-item active">Crear Unidad de Medida</li>
    </ol>
                ...
                <div class="row mb-4">
                    ...
                    <div class="col-lg-4">
                        <select name="tipo"
                            ...
                            <option value="peso" @selected(old('tipo')=='peso')>Peso</option>
                            <option value="volumen" @selected(old('tipo')=='volumen')>Volumen</option>
                            <option value="longitud" @selected(old('tipo')=='longitud')>Longitud</option>
                            <option value="unidad" @selected(old('tipo')=='unidad')>Unidad</option>
                            <option value="area" @selected(old('tipo')=='area')>Área</option>
                            <option value="tiempo" @selected(old('tipo')=='tiempo')>Tiempo</option>
                        </select>
                        @error('tipo')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
