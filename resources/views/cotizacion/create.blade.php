...
@section('title', isset($cotizacione) ? 'Duplicar Cotización' : 'Crear Cotización')
...
<div class="container-fluid px-4">
    <h1 class="mt-4 text-center">
        <i class="fas fa-file-invoice"></i> {{ isset($cotizacione) ? 'Duplicar Cotización' : 'Nueva Cotización' }}
    </h1>
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item"><a href="{{ route('panel') }}">Inicio</a></li>
        <li class="breadcrumb-item"><a href="{{ route('cotizaciones.index')}}">Cotizaciones</a></li>
        <li class="breadcrumb-item active">{{ isset($cotizacione) ? 'Duplicar' : 'Crear' }}</li>
    </ol>
                    ...
                    <div class="row gy-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <small class="text-info">
                                <i class="fas fa-info-circle"></i> Solo referencia, no se descuenta en cotización
                            </small>
                        </div>
                        ...
                        <div class="col-12">
                            <div class="table-responsive">
                                <table id="tabla_detalle" class="table table-hover table-bordered">
                                    ...
                                    <tbody>
                                        @if(isset($cotizacione) && $cotizacione->productos)
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th colspan="2">Q <span id="sumas">{{ isset($cotizacione) ? number_format($cotizacione->subtotal, 2) : '0.00'}}</span></th>
                                        </tr>
                                        <tr>
                                            <th colspan="5" class="text-end">IVA (12%):</th>
                                            <th colspan="2">Q <span id="iva">{{ isset($cotizacione) ? number_format($cotizacione->impuesto, 2) : '0.00'}}</span></th>
                                        </tr>
                                        <tr class="table-primary">
                                            <th colspan="5" class="text-end">TOTAL:</th>
                                            <th colspan="2">
                                                <input type="hidden" name="total" value="{{ isset($cotizacione) ? $cotizacione->total : 0}}" id="inputTotal">
                                                Q <span id="total">{{ isset($cotizacione) ? number_format($cotizacione->total, 2) : '0.00'}}</span>
                                            </th>
                                        </tr>
                                    </tfoot>
                                </table>
                        ...
                        <div class="col-12">
                            <button id="cancelar" type="button" class="btn btn-danger"
                                    ...
                                    style="{{ isset($cotizacione) ? 'display: block;' : 'display: none;' }}">
            ...
            <div class="col-xl-4">
                ...
                <div class="p-3 border border-3 border-success">
                    <div class="row gy-3">
                        ...
                        <div class="col-12">
                            ...
                            <select name="cliente_id" id="cliente_id"
                                ...
                                <option value="{{$item->id}}"
                                        @if(isset($cotizacione) && $cotizacione->cliente_id == $item->id) selected @endif>
                        ...
                        <!--Número cotización-->
                        <div class="col-12">
                            <label for="numero_cotizacion" class="form-label">Número:</label>
                            <input readonly type="text" name="numero_cotizacion" id="numero_cotizacion"
                                   class="form-control border-success bg-light fw-bold"
                        ...
                        <div class="col-6">
                            ...
                            <input type="number" name="validez_dias" id="validez_dias"
                                   ...
                                   value="{{ isset($cotizacione) ? $cotizacione->validez_dias : $diasValidez }}"
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="observaciones" id="observaciones"
                                      ...
                                      rows="3"
                                      maxlength="1000"
                                      placeholder="Condiciones, notas especiales...">{{ isset($cotizacione) ? $cotizacione->observaciones : old('observaciones') }}</textarea>
                            <small class="text-muted">
                                <span id="contador_obs">0</span>/1000 caracteres
                            </small>
                            @error('observaciones')
                        ...
                        <div class="col-6">
                            ...
                            <input readonly type="text" name="subtotal" id="subtotal"
                                   ...
                                   value="{{ isset($cotizacione) ? $cotizacione->subtotal : '0.00'}}">
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <input readonly type="text" name="impuesto" id="impuesto"
                                   class="form-control border-success"
                                   value="{{ isset($cotizacione) ? $cotizacione->impuesto : '0.00'}}">
                        </div>
                        ...
                        <div class="col-12">
                            <div class="alert alert-info mb-0" role="alert">
                                ...
                                <strong>Nota:</strong>
                                La cotización no descuenta stock. Puede convertirse a venta dentro del período de validez.
                            </div>
                        </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ¿Seguro que quieres cancelar? Se perderán todos los productos agregados.
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">No, continuar</button>
                    <button id="btnCancelar" type="button" class="btn btn-danger" data-bs-dismiss="modal">
                        Sí, cancelar
                    </button>
                </div>
            </div>
...
$(document).ready(function() {
    ...
    @if(isset($cotizacione) && $cotizacione->observaciones)
        $('#contador_obs').text({{ strlen($cotizacione->observaciones) }});
    @endif
    ...
    $('#formCotizacion').submit(function(e) {
        ...
        return confirm('¿Está seguro de guardar esta cotización?');
    });
});

let cont = {{ isset($cotizacione) ? $cotizacione->productos->count() : 0 }};
let subtotal = [];
